...
const SignUpScreen = (props) => {
    ...
    return (
        <div className="Screen">
                <div className="row">
                    <div className="col-md-6 offset-xl-3">
                    ...
                    <Header title="SignUp"/>
                    {
                        error && error.status === "error" && <h5 className="text-danger text-center">{error.message}</h5>
                            ...
                            <div className="mb-3 float-start">
                                <button onClick={onSignUp} type="button" className="btn btn-primary">Register</button>
                            </div>
                            { 
                            !userSignIn.response && 
                            <div className="col-md-4 offset-xl-9 float-end">
