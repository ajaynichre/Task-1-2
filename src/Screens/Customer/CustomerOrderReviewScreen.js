            ...
            <div className="row">
                <div className="col-md-6 Block parent-block">
                    ...
                    <div id="order-action-block">
                        <button className="btn btn-info" onClick={()=>{props.history.push("/customer-products")}}>Continue Shopping</button>
                        <button className="btn btn-success NextBtn" onClick={onConfirmOrder} >Confirm Order</button>
                    </div>
                </div>
